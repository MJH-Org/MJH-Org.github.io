...
await cp(resolve(root, 'frontend/marked.html'), resolve(docsDir, 'marked.html'));
...
await cp(resolve(root, 'frontend/supabase-config.js'), resolve(docsDir, 'supabase-config.js'));
...
await cp(resolve(docsDir, 'marked.html'), resolve(root, 'marked.html'));
...
await cp(resolve(docsDir, 'supabase-config.js'), resolve(root, 'supabase-config.js'));
